...
def assemble_episodic_data(stays, diagnoses):
    data = {'Icustay': stays.ICUSTAY_ID, 'Age': stays.AGE, 'Length of Stay': stays.LOS,
            'Mortality': stays.MORTALITY, 'Readmission':stays.DAYS_NEXT_ADMIT, 'Survival': stays.SURVIVAL}
    ...
    data = data[['Ethnicity', 'Gender', 'Age', 'Height', 'Weight', 'Length of Stay', 'Mortality', 'Readmission', 'Survival']]
